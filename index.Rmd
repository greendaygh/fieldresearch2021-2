...
- Linux + docker (Seongbo)
  - Objective: To build Rstudio env
- R language (A-young)
  - Objective: BT Codon design 
- Tensorflow, Keras (Aporva, Wonjae)
  - Objective (Aporva): To understand how alphafold2 & rosettafold work
  - Objective (Wonjae): To build tensorflow models (data)
- Git 
- PDB, NCBI DB API (SeongKun)
