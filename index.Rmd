...
- 보고서 구조 완성 및 pdf 형태로 rmarkdown 마무리 요청
- rmarkdown 사용법 등 배우는 것을 목적으로

## 허성보

- 보고서 구조 완성 리눅스에서 Rocker (docker) 실행하는 코드 실습

## 고민지

- Rstudio에서 엑셀 파일 읽고 그래프 그리기
- tidyverse 패키지 활용 실제 데이터 엑셀파일 막대그래프 그리기

## 박성군

- demultiplexing 코드 리뷰 
- Bash script 형대로 진행, R CMD 활용

## Aporva

- 단백질 엔지니어링 툴 개발 기본 방향 설명
- 보고서 Intro, Dicussion 보강 요청
